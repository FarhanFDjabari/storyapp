package com.example.storyapp.data.services
...
import com.example.storyapp.data.services.local.RemoteKeys
    ...
    override suspend fun load(loadType: LoadType, state: PagingState<Int, Story>): MediatorResult {
        ...
        try {
            ...
            database.withTransaction {
                ...
                database.storyDao().insertStory(responseData.body()?.listStory?: listOf())
            }
